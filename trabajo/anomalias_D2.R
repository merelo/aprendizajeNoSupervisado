...
# Trabajamos sobre las columnas num?ricas de LetterRecognition [1:4]
...
# mis.datos.numericos -> con las columnas 1:4 de LetterRecognition
...
#   El resultado lo guardamos en la variable indices.clustering.LetterRecognition
#   Por ejemplo, si el dato con ?ndice 69 est? asignado al tercer cluster,
#   en el vector indices.clustering.LetterRecognition habr? un 3 en la componente n?mero 69
...
#   El resultado lo guardamos en la variable centroides.normalizados.LetterRecognition
...
# COMPLETAR
dist.centroides.LetterRecognition<-distancias_a_centroides(mis.datos.numericos.normalizados,indices.clustering.LetterRecognition,centroides.normalizados.LetterRecognition)
dist.centroides.LetterRecognition
top.outliers.LetterRecognition<-order(dist.centroides.LetterRecognition,decreasing=TRUE)[1:numero.de.outliers]
top.outliers.LetterRecognition
...
# COMPLETAR
top.outliers.kmeans<-top_clustering_outliers(mis.datos.numericos.normalizados,indices.clustering.LetterRecognition, centroides.normalizados.LetterRecognition, numero.de.outliers)
...
# es decir, tenemos que multiplicar centroides.normalizados.LetterRecognition[i]  por mis.datos.desviaciones[i] 
...
mis.datos.desviaciones.por.centroides<-sweep(centroides.normalizados.LetterRecognition,mis.datos.desviaciones, FUN = "*",MARGIN = 2)
...
# En el ejemplo del LetterRecognition, nos quedar?a:
#    [,1]  [,2]  [,3]
# 1   TRUE FALSE FALSE
# 2   TRUE FALSE FALSE
# ......
...
# Llamamos a la funci?n as? construida con los datos de LetterRecognition y mostramos el Biplot correspondiente.
...
BIPLOT.cluster.colors        = colors()[sample(1:length(colors()),numero.de.clusters,replace=FALSE)]     # Tantos colores como diga numero.de.clusters
